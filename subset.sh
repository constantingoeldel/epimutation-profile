...
> /mnt/extStorage/constantin/methylome/cg_bed/$i.change.bed; done
echo Done filtering CGs
cd /mnt/extStorage/constantin/methylome/cg_bed
for i in methylome_*.txt.change.bed; do bedtools intersect -a $i -b /mnt/extStorage/constantin/gbM_gene_anotation_extract_Arabidopsis.bed  -wa -wb -f 1 \
